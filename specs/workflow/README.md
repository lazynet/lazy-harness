...
**TDD discipline** is not duplicated here. The repo's TDD rules follow the `superpowers:test-driven-development` skill exactly; invoke that skill via the `Skill` tool when you start any code change. `AGENTS.md` is the authoritative pointer.
