...
- **The MCP block does not go to `settings.json`.** ADR-032 L2 put the file name behind the adapter; `ClaudeCodeAdapter.mcp_config_file()` returns `.claude.json`. See ADR-024's Evolution note.
